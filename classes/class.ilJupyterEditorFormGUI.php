...
class ilJupyterEditorFormGUI extends ilFormPropertyGUI
{
    ...
    function getHtml()
    {
        ...
        $applet->setVariable('IFRAME_SRC', 'https://127.0.0.11/jupyter/user/' . $this->jupyter_user_credentials['user'] . '/notebooks/test.ipynb?token=' . $this->jupyter_user_credentials['token']);
