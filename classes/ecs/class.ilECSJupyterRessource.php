...
class ilECSJupyterRessource 
{
	...
	{
		$new_id = $this->getDB()->nextId('il_qpl_qst_jupyter_res');
		$query = 'INSERT INTO il_qpl_qst_jupyter_res (id, res_id, ecs_res, create_dt) '.
				'VALUES ( '.
	...
	{
		$query = 'DELETE FROM il_qpl_qst_jupyter_res '.
	...
	{
		$query = 'SELECT * FROM il_qpl_qst_jupyter_res '.
				'WHERE id = '. $this->getDB()->quote($this->getId(),'integer');
